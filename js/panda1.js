...
function show_gift_options (theAmount){
    if (theAmount < 10 && theAmount>0){
        water_bottle.style.display="none";
...
// ---------------------------------------------------------
//  change on 'other' amount when clicked // type "other amount"
// ---------------------------------------------------------
...
user_amount.addEventListener('click', function(e){
        ...
        user_amount.style.boxShadow="0px 0px 5px blue";
        ...
        input_field.style.width='80px';
        input_field.style.height='35px';
        input_field.style.fontSize='18px';
        input_field.style.position="relative";
        input_field.style.paddingLeft="17px";
        input_field.style.top = "2px";
     
        var dollar_span= document.getElementById("dollar_sign");
        dollar_span.style.display="inline-block";
        dollar_span.style.position="relative";
        dollar_span.style.top = "-35px";
        dollar_span.style.left= "5px";


        input_field.addEventListener('keyup', function(){

            var theAmount= parseInt(input_field.value);
